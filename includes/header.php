...
<link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>/PgwSlider-master/pgwslider.css">

<?php
include_once 'template/js.php';
?>
<script src="<?php echo base_url; ?>/PgwSlider-master/pgwslider.js"></script>  
<script src="<?php echo base_url; ?>/PgwSlider-master/pgwslider.min.js"></script>  
<script src="<?php echo base_url; ?>/PgwSlider-master/pgwslider.jquery.json"></script>  
</head>
<body>
